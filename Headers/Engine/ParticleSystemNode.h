...
namespace Engine
{
	...
	class ParticleSystemNode : public WorldNode
	{
	 public:
		 ...
		 */
		explicit ParticleSystemNode(AlphaSquadron::ParticleType type);
		 ...
		 */
		AlphaSquadron::ParticleType getParticleType() const
		{
			return m_type;
		};
		...
		{
			return WorldNode::getNodeType() | static_cast<unsigned int>(AlphaSquadron::NodeType::ParticleSystem);
		}
	 ...
	 private:
		...
		AlphaSquadron::ParticleType m_type;               ///< The type of particles managed.

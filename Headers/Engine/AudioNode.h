...
namespace Engine
{
	...
	class AudioNode : public WorldNode
	{
	 public:
		 ...
		 */
		void playSound(AlphaSquadron::SoundFxId sound, sf::Vector2f position, float volume)
		{
			m_audioPlayer.playSound(sound, position, volume);
		}
		...
		{
			m_audioPlayer.playMusic(musicType, volume);
		}
		...
		{
			return WorldNode::getNodeType() | static_cast<unsigned int>(AlphaSquadron::NodeType::Sound);
		}

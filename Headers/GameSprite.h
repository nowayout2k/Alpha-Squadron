...
class GameSprite : public WorldNode
{
 public:
	...
	explicit GameSprite(const bool hasCollision, const TextureId textureId, const bool centerOrigin = false,
		const sf::IntRect textureLoadArea = sf::IntRect(), const sf::IntRect spriteTextureRegion = sf::IntRect(),
	 ...
	 */
	unsigned int getNodeType() const override { return WorldNode::getNodeType() | static_cast<unsigned int>(NodeType::GameSprite); }
 ...
 private:
	...
	TextureId m_textureId;             ///< Identifier for the sprite's texture.

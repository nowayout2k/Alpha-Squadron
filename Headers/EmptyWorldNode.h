...
namespace Engine
{
	...
	class EmptyWorldNode : public WorldNode
	{
	 public:
		 ...
		 */
		EmptyWorldNode() : m_type(AlphaSquadron::NodeType::None)
		{
		}
		 ...
		 */
		explicit EmptyWorldNode(AlphaSquadron::NodeType type) : m_type(type)
		{
		}
		...
		{
			return WorldNode::getNodeType() | static_cast<unsigned int>(m_type);
		}
	 ...
	 private:
		AlphaSquadron::NodeType m_type; ///< The specific node type for this empty node.
	};
}

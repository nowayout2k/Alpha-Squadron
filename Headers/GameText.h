...
namespace Engine
{
	...
	class GameText : public WorldNode
	{
	 public:
		 ...
		 */
		virtual unsigned int getNodeType() const override
		{
			return WorldNode::getNodeType() | static_cast<unsigned int>(AlphaSquadron::NodeType::Text);
		}
		...
		{
			m_text.setFont(AlphaSquadron::ResourceManager::loadResource(m_fontType));
		}

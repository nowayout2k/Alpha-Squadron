...
{
	GameOverState::GameOverState(Engine::StateStack& stack, Context context, const std::string& text)
		: State(stack, context), m_gameOverText(), m_elapsedTime(0.f)
	{
		...
		Engine::Utility::centerOrigin(m_gameOverText);

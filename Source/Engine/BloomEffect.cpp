...
#include "../../Headers/Engine/BloomEffect.h"
...
namespace Engine
{
	...
	{
		sf::Shader& brightness = AlphaSquadron::ResourceManager::loadResource(Engine::ShaderId::BrightnessPass);
	...
	{
		sf::Shader& gaussianBlur = AlphaSquadron::ResourceManager::loadResource(ShaderId::GaussianBlurPass);
	...
	{
		sf::Shader& downSampler = AlphaSquadron::ResourceManager::loadResource(ShaderId::DownSamplePass);
	...
	{
		sf::Shader& adder = AlphaSquadron::ResourceManager::loadResource(ShaderId::AddPass);

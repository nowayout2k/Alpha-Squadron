...
#include "../../Headers/Engine/ParticleSystemNode.h"
namespace Engine
{
	ParticleSystemNode::ParticleSystemNode(AlphaSquadron::ParticleType type)
		: m_particles(),
		  m_texture(AlphaSquadron::ResourceManager::loadResource(AlphaSquadron::TextureId::Particle)),
	...
	void ParticleSystemNode::computeVertices() const
	{
		...
		for (const Particle& particle : m_particles)
		{
			...
			float ratio = particle.Lifetime.asSeconds() / AlphaSquadron::World::GameData.ParticleData[m_type].Lifetime.asSeconds();
	...
	void ParticleSystemNode::addVertex(float worldX,
		float worldY,
		float texCoordX,
		float texCoordY,
